...
public class SeasonCommitRequest {
    ...
    @Schema(description = "The sanity checks are a warning, not a wall: true commits a draft whose numbers don't add up anyway. Leave it out and a blocked draft answers 409.", example = "false")
    private boolean commitAnyway;
}
